...
def tune_rf_pipeline(X_train: pd.DataFrame, y_train: pd.Series) -> Pipeline:
    ...
    Ains for the best hyperparameters for RandomForestClassifier in the pipeline, optimizing the metric
    ...
    randomized_seach = RandomizedSearchCV(estimator=pipeline, param_distributions=params, n_iter=20, 
                                          ...
                                          # 'f1' algo would be a good option if the objetive was find the best balance in a specific threshold.
